...
<main class="p-home">
    ...
    <div class="l-container">
        <div class="c-grouplink">
            <a href="<?php echo get_site_url(); ?>/thoughts"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/img_01_no.png" alt="Introducing our philosophy" class="js-imglink"></a>
            <a href="<?php echo get_site_url(); ?>/strengths"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/img_02_no.png" alt="Introducing our 6 strengths" class="js-imglink"></a>
            <a href="<?php echo get_site_url(); ?>/service"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/img_03_no.png" alt="Introducing our service" class="js-imglink"></a>
        </div>
        <!-- INTRODUCING end -->
        ...
        <div class="c-grouplink">
            <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/btn_03_no.png" alt="所員紹介" class="js-imglink"></a>
            <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/btn_04_no.png" alt="事務所案内" class="js-imglink"></a>
        </div>
            ...
            <?php foreach ($access as $item) : ?>
                <div class="c-access">
                    ...
                    <div class="c-access__info">
                        ...
                        <p>
                            <?php if ($item['tel']) : ?>
                                <span class="tel">tel : <a class="c-access__tel" href="tel:+<?php echo $item['tel']; ?>"><?php echo $item['tel']; ?></a></span>
                            <?php endif; ?>
                            <?php if ($item['fax']) : ?>
                            ...
                            <?php if ($item['email']) : ?>
                                <span class="email">
                                    mail : <a class="u-defaulthover" href="mailto:<?php echo $item['email']; ?>"><?php echo $item['email']; ?></a>
                                </span>
                            <?php endif; ?>
                        </p>
                    </div>
