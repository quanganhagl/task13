...
<body>
    <header class="c-header">
        <div class="l-container">
            ...
            <nav class="c-gnav">
                <ul>
                    <li class="thoughts"><a href="<?php echo get_site_url(); ?>/thoughts">私たちの想い</a></li>
                    <li class="strengths"><a href="<?php echo get_site_url(); ?>/strengths">6つの強み</a></li>
                    <li class="service"><a href="<?php echo get_site_url(); ?>/service">サービス</a></li>
                    <li class="staff"><a href="<?php echo get_site_url(); ?>/staff">所員の紹介</a></li>
                    <li class="office"><a href="<?php echo get_site_url(); ?>/office">事務所案内</a></li>
                </ul>
            </nav>
